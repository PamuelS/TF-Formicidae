# This script run on the file pgls5_significant_OGs.tsv which has been created with the constrains of: p-value < 0.05 and R^2 adj > 0.25

library(tidyverse)

# File reading
data_filtered <- read.table("pgls5_significant_OGs.tsv", 
                             header = TRUE, sep = " ")
...
ggsave("motif_bias_plot_rsqu.pdf", width = 12, height = 5, dpi = 300)
ggsave("motif_bias_plot_rsqu.png", width = 12, height = 5, dpi = 300)
