...
output_dir  <- "OG_only_pvalue_significant"
...
write.table(df_sig,
          file      = file.path(output_dir, "pgls5_significant_OGs_pvalue_only.tsv"),
          row.names = FALSE)
...
# 4c. Salva un singolo file TSV per ogni motivo estratto
