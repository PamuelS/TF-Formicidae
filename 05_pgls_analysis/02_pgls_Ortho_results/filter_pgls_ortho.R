...
input_file <- "merged_pgls5_Ortho_castes.tsv"

message("==================================================")
message(" Running PGLS Filter for Ortho results")
...
generate_summary(df_sig_pval, "pgls5_ortho_summary_by_motif_pval.tsv")
generate_summary(df_sig_fdr,  "pgls5_ortho_summary_by_motif_fdr.tsv")
