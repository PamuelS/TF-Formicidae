...
# ──────────────────────────────────────────────
#write.csv(res_pgls1,  output_path,  row.names = FALSE)
#write.csv(res_pgls2,  output_path,  row.names = FALSE)
write.csv(res_pgls3,  output_path,  row.names = FALSE)
#write.csv(res_pgls4a, output_path, row.names = FALSE)
#write.csv(res_pgls4b, output_path, row.names = FALSE)
#write.csv(res_pgls5,  output_path,  row.names = FALSE)
#write.csv(res_pgls6a, output_path, row.names = FALSE)
#write.csv(res_pgls6b, output_path, row.names = FALSE)
