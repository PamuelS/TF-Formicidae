...
```bash
bash ../02_DISCO_OG/split_disco_output /DATASMALL/samuel.pederzini/TF-Formicidae/02_orthology/00_OrthoFinder_analysis/OrthoFinder/Resluts_Mar30_1/Orthogroup_sequences
```
